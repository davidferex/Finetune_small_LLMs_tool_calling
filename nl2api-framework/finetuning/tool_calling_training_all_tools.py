...
dataset = load_dataset("json", data_files="train_lora_all_tools.jsonl", split="train")
...
username="davidferex"
output_dir = "TFM_all_tools" # The directory where the trained model checkpoints, logs, and other artifacts will be saved. It will also be the default name of the model when pushed to the hub if not redefined later.
...
wandb.init(
    ...
    config={
        "model": model_name,
        "dataset": "train_lora_all_tools.jsonl",
        "lr": learning_rate,
