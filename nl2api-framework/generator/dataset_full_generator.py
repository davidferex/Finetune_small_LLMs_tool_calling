...
def build_lora_dataset(input_folder="dataset_raw2", output_file="train_lora.jsonl"):
    ...
    system_prompt = (
        ...
        f"You may call one or more functions to assist with the user query. Don't make assumptions about what values to plug into functions, if information is missing for the parameters use the tool 'MoreInformationNeeded'."
    ...
    for tool in TOOLS_SPEC:
        ...
        with open(file_path, 'r') as f:
            ...
            for s in samples:
                ...
                # Construir el payload de la tool_call
                tool_call_payload = {
                ...
                # Bloque MODEL (en una sola línea el JSON para evitar problemas de espacio)
