...
# CONFIG
# ==========================================================
TOOLCALLS_JSON = "dataset_train_all_tools/full_training_dataset.json"   # json con tool calls correctas
MLP_JSON       = "dataset_train_all_tools/full_training_dataset_mlp.json"         # json queries completas/incompletas
OUTPUT_JSON    = "verifier_dataset_train_all_tools.json"
