...
def run_dataset_generation(n_samples_completas: int = 50):
    ...
    for tool in TOOLS_SPEC:
        ...
        # Guardar por tool
        with open(f"dataset_train/{tool['name']}.json", "w", encoding="utf-8") as f:
            json.dump(tool_results, f, indent=4, ensure_ascii=False)

        with open(f"dataset_train/{tool['name']}_mlp.json", "w", encoding="utf-8") as f:
    ...
    with open("dataset_train/full_training_dataset.json", "w", encoding="utf-8") as f:
        json.dump(final_dataset, f, indent=4, ensure_ascii=False)

    with open("dataset_train/full_training_dataset_mlp.json", "w", encoding="utf-8") as f:
